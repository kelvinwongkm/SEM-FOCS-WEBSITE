<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnrolmentAccept.aspx.cs" Inherits="SEAM_Assignment.ProgrammeModule.EnrolmentAccept" %>
        ...
        <div style="display: flex; justify-content: center; align-items: center; height: 100vh; text-align: center; background-color: #eeeeee;">
            <section id="secMessage">
                ...
                <div style="margin-top: 20px;">
                    <asp:Label ID="lblMessage" runat="server" Text="Your enrolment is accepted!"></asp:Label>
                </div>
