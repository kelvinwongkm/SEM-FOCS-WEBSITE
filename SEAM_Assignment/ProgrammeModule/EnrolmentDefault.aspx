<%@ Page Title="" Language="C#" MasterPageFile="~/UserHeaderFooter.Master" AutoEventWireup="true" CodeBehind="EnrolmentDefault.aspx.cs" Inherits="SEAM_Assignment.ProgrammeModule.EnrolmentDefault" %>
    ...
    <div style="display: flex; padding: 80px 0; justify-content: center; align-items: center; text-align: center; background-color: #eeeeee;">
        <section id="secMessage">
            ...
            <div style="margin-top: 20px;">
                <asp:Label ID="lblMessage" runat="server" Text="Please login to your account to submit enrolment."></asp:Label>
            </div>
